...
const translations = {
  en: {
    ...
    learning: "This website showcases my projects, skills, and learning journey. I built it while learning web development and programming. Throughout the process, I leveraged AI tools to accelerate development and solve problems efficiently. At the same time, I focused on understanding the core principles of how websites work, including programming languages, their features, and underlying concepts.",
